...
import { RegisterContent, orContent } from "../../Components/js/content";
            ...
            <form className="w-full max-w-sm bg-white p-8 rounded-xl shadow-0 space-y-6">
                ...
                <div className="text-center">
                    <h1 className="text-2xl font-extrabold text-gray-900">
                        {orContent.createAccount.title}
                    </h1>
                    <p className="mt-2 text-gray-600">
                        {orContent.createAccount.exists}{" "}
                        <a
                            href={orContent.createAccount.redirect}
                            className="text-orange-600 hover:text-orange-700 font-semibold transition underline"
                        >
                            {orContent.createAccount.redirectContent}
                        </a>
                    </p>
                </div>
